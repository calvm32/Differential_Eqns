from equation_solvers.timestep_solvers.rk4_solvers.rk4_ndim import rk4_ndim
import numpy as np
...
"""
This program plots random solutions to the Lorenz system using an RK4 solver
"""
